...
<head>
    ...
    <form class="form-horizontal" method = "post" action= "/modify"  enctype="multipart/form-data">
    ...
    <p class="form-control-static"><input type="file" name="file"></p>
    </c:if>
    <c:if test="${vo.getIsfile() == 'T' }">
    <p class="form-control-static">${vo.getFilename()} &nbsp;&nbsp;&nbsp;<b><a href="/deletefile?filename=${vo.getFilename()}&bbsno=${param.bbsno}">delete</a></b></p>
    </c:if>
    </div>
  </div>
<div class="form-group">
