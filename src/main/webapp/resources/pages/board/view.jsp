...
<head>
    ...
    <form class="form-horizontal" method = "GET" action= "/delete">
...
<div class="col-xs-offset-1 col-xs-10">
   <button type="button" class="btn btn-primary btn-lg" onclick="window.location='/modify?bbsno=${vo.getBbsNo()}'">
      Modify
   </button>
   <button type="button" class="btn btn-default btn-lg" onclick="window.location='/delete?bbsno=${vo.getBbsNo()}'">Delete
   </button>
</div>
</div>
    </form>
